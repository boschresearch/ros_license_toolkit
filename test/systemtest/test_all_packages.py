...
class TestAllPackages(unittest.TestCase):
    ...
    def test_all(self):
        ...
        self.assertIn(b"test_pkg_with_multiple_licenses_no_source_files_tag_v3", stdout)
        self.assertIn(b"test_pkg_with_multiple_licenses_no_source_files_tag_v4", stdout)
